...
#1 DOWNLOAD ----------------------
url = "https://www.youtube.com/playlist?list=PLKPsodKLvXr96RV8oRFtYQbZyPaL2t2TT"
...
ul = soup.find("ytd-playlist-video-list-renderer", "style-scope ytd-item-section-renderer")
print(ul.prettify())
