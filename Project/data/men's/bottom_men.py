...
class bottom_men(Document):
    name = StringField()
    image = StringField()

# DOWNLOAD PAGE >>>>>>>>>>>>>>>>
url = "https://topodesigns.com/collections/mens-bottoms"
...
for st in li_list:
    ...
    # print(image)
    # print('saving...')
    # new = bottom_men(name = name, image = image)
    # new.save()
    # print('saved')
...
# SAVE DATA TO EXCEL >>>>>>>>>>>>>>>>
pyexcel.save_as(records= news_list, dest_file_name = "men_bottom.xlsx")