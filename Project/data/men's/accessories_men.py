...
class accessories_men(Document):
    name = StringField()
    image = StringField()

# DOWNLOAD PAGE >>>>>>>>>>>>>>>>
url = "https://topodesigns.com/collections/mens-accessories"
...
for st in li_list:
    ...
    # print(name)
    # print(image)
    # new = accessories_men(name = name, image = image)
    # new.save()
...
# SAVE DATA TO EXCEL >>>>>>>>>>>>>>>>
pyexcel.save_as(records= news_list, dest_file_name = "men_accessories.xlsx")