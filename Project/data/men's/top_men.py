...
class top_men(Document):
    name = StringField()
    image = StringField()

# DOWNLOAD PAGE >>>>>>>>>>>>>>>>
url = "https://topodesigns.com/collections/mens-tops"
...
for st in li_list:
    ...
    # # print(name)
    # # print(image)
    # new = top_men(name = name, image = image)
    # new.save()
    news = OrderedDict({
        "Name": name,
        "Image": image,
...
# SAVE DATA TO EXCEL >>>>>>>>>>>>>>>>
pyexcel.save_as(records= news_list, dest_file_name = "men_top.xlsx")