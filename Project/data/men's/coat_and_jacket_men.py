...
class coat_and_jacket_men(Document):
    name = StringField()
    image = StringField()

# DOWNLOAD PAGE >>>>>>>>>>>>>>>>
url = "https://topodesigns.com/collections/mens-outerwear"
...
for st in li_list:
    ...
    # print(name)
    # print(image)   
    # new = coat_and_jacket_men(name = name, image = image)
    # new.save()
...
# SAVE DATA TO EXCEL >>>>>>>>>>>>>>>>
pyexcel.save_as(records= news_list, dest_file_name = "men_coat&jacket.xlsx")