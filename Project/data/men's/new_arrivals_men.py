...
class new_arrivals_men(Document):
    name = StringField()
    image = StringField()

# DOWNLOAD PAGE >>>>>>>>>>>>>>>>
url = "https://topodesigns.com/collections/new-arrivals-men"
...
for st in li_list:
    ...
    # print(name)
    # print(image)
    # new = new_arrivals_men(name = name, image = image)
    # new.save()
...
# SAVE DATA TO EXCEL >>>>>>>>>>>>>>>>
pyexcel.save_as(records= news_list, dest_file_name = "man_newarrivals.xlsx")